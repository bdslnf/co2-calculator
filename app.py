...
def parse_swiss_number(text):
    """Konvertiert Schweizer Format (mit Apostrophen) zurück zu Zahl."""
    if not text:
        return 0
...
### **1. TEXT INPUT mit Live-Formatierung** (Zeile 239-251)
```
Betrag eingeben [CHF]:
┌──────────────┐
│ 100'000      │  ← APOSTROPHE IN DER EINGABE!
└──────────────┘
```

### **2. Slider Info mit Apostrophen** (Zeile 271-273)
```
📊 Bereich: 0 - 2'000'000 CHF
```

### **3. Große Anzeige mit Apostrophen** (Zeile 268-269)
```
✅ Gewählt: CHF 750'000
